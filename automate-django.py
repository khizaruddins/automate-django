...
def set_folder_structure():
    dirCreation = '''cd {p} && mkdir templates templates/{x} templates/{x}/partials templates/{x}/layouts templates/{x}/extras static static/css static/js static/images media'''.format(p=currentProject, x=currentApp)
    run_cmd(dirCreation)
